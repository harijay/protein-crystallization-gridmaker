...
def main():
	...
	p.push_gradient_start_stop_x(peg400,18,25)
	p2.push_gradient_start_stop_x(peg400,18,25)
	p3.push_gradient_start_stop_x(peg400,18,25)
	p4.push_gradient_start_stop_x(peg400,18,25)
	...
	pwhole.push_components_mapped_to_row([b1,b2,b3,b4,b1,b2,b3,b4],[100,100,100,100,100,100,100,100],["A",1,"C","D","E","F","G","H"])
