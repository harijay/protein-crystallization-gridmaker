...
def main():
	...
	srcl = component.Component("SrCl",1,100000)
	...
	p1.constant_salt(mp,cabr,0.05)
	p2.constant_salt(mp,cabr,0.1)
	p3.constant_salt(mp,srcl,0.05)
	p4.constant_salt(mp,srcl,0.1)
	...
	mp.makefileforformulatrix("example11.dl.txt")
