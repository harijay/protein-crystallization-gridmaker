...
import buffercomponent, component, plate, masterplate
...
def main():
	...
	# We want each quadrant ( i.e pla   te p , p2 , p3 and p4 ) to have a constant concentration of Calcium Chloride
	...
	p.constant_salt(salt,25)
	p2.constant_salt(salt,50)
	p3.constant_salt(salt,100)
	p4.constant_salt(salt,150)
