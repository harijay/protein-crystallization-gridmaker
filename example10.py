...
def main():
	...
	p.push_gradient_list_y(mp,ammso,[1.8,2.1,2.4,2.7])
	p2.push_gradient_list_y(mp,sodcl,[2.7,3,3.3,3.6])
	p3.push_gradient_list_y(mp,amformate,[3,3.9,4.8,5.4])
	p4.push_gradient_list_y(mp,sodformate,[4,5,6,7])
	
	# Here we fill each sub plate with water : in example 3 you will see a shortcut way of doing this 
	
	p.push_buffer_to_column_on_masterplate(mp,b1,100,1)
	p.push_buffer_to_column_on_masterplate(mp,b2,100,2)
	p.push_buffer_to_column_on_masterplate(mp,b3,100,3)
	p.push_buffer_to_column_on_masterplate(mp,b4,100,4)
	p.push_buffer_to_column_on_masterplate(mp,b5,100,5)
	p.push_buffer_to_column_on_masterplate(mp,b6,100,6)
			
	p2.push_buffer_to_column_on_masterplate(mp,b1,100,7)
	p2.push_buffer_to_column_on_masterplate(mp,b2,100,8)
	p2.push_buffer_to_column_on_masterplate(mp,b3,100,9)
	p2.push_buffer_to_column_on_masterplate(mp,b4,100,10)
	p2.push_buffer_to_column_on_masterplate(mp,b5,100,11)
	p2.push_buffer_to_column_on_masterplate(mp,b6,100,12)
	
	p3.push_buffer_to_column_on_masterplate(mp,b1,100,1)
	p3.push_buffer_to_column_on_masterplate(mp,b2,100,2)
	p3.push_buffer_to_column_on_masterplate(mp,b3,100,3)
	p3.push_buffer_to_column_on_masterplate(mp,b4,100,4)
	p3.push_buffer_to_column_on_masterplate(mp,b5,100,5)
	p3.push_buffer_to_column_on_masterplate(mp,b6,100,6)
	
	p4.push_buffer_to_column_on_masterplate(mp,b1,100,7)
	p4.push_buffer_to_column_on_masterplate(mp,b2,100,8)
	p4.push_buffer_to_column_on_masterplate(mp,b3,100,9)
	p4.push_buffer_to_column_on_masterplate(mp,b4,100,10)
	p4.push_buffer_to_column_on_masterplate(mp,b5,100,11)
	p4.push_buffer_to_column_on_masterplate(mp,b6,100,12)
